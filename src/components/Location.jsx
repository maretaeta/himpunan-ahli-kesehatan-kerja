...
const Location = () => {
  return (
    <div name="Location" className=" md:flex md:justify-between grid justify-items-center max-w-6xl py-16 mt-10 mx-auto">
      <div className="mb-5">
      ...
      <iframe
        id="iframe1"
        className="rounded-md md:w-[700px] w-96 h-80"
