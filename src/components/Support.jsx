  ...
  <div name='support'  className='w-full mt-24'>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div data-aos-offset="400" data-aos="flip-left" className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
              ...
              <div data-aos-offset="400" data-aos="flip-right" className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
