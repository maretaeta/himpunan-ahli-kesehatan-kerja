    ...
    <div name="support" className="w-full mt-24">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black">
          ...
          >
            <div className="p-8">
              <PhoneIcon className="w-16 p-4 bg-[#007936] text-white rounded-lg mt-[-4rem]" />
            ...
            <div className="bg-slate-100 pl-8 py-4">
              <p className="flex items-center text-[#007936]">
                More
          ...
          >
            <div className="p-8">
              <SupportIcon className="w-16 p-4 bg-[#007936] text-white rounded-lg mt-[-4rem]" />
          ...
          >
            <div className="p-8">
              <ChipIcon className="w-16 p-4 bg-[#007936] text-white rounded-lg mt-[-4rem]" />
