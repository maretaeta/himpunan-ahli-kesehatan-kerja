        ...
        <div class="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div class="m-5 ">
            <h6 class="mb-4 md:flex items-center justify-center font-semibold uppercase md:justify-start md:grid-cols-2">
              <img
                src={logo}
                className="w-24 grid grid-cols-1 justify-items-center mx-auto pr-3"
              ></img>
              PERHIMPUNAN AHLI KESEHATAN KERJA INDONESIA
            </h6>
            <p>
              Sekretariat / Secretariat : Gedung C Lantai 3, Fakultas Kesehatan
              Masyarakat, Universitas Indonesia, Kampus Baru UI Depok 16424.
            </p>
          </div>
          <div className="pt-6">
